<?php include 'actionupdatestock.php'?>
        ...
        <section class="content">
          ...
          <div class='box box-default'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class="fa fa-tag"></i> Kemaskini Stok Ubat</h3>
            </div>
            <div class='box-body'>
            ...
            echo "<script>window.location.href='pekerja_stokubat.php';</script>"; } ?>
            </div>
			   ...
			   <tr>
					<td><b>Nama Ubat</b></td><td>:</td><td><input type="text" name="name" value="<?php echo $row['ubatName']; ?>">
         ...
         <td colspan="3">&nbsp;</td> 
			    ...
			    <tr>
					<td><b>Kuantiti Baru</b></td><td>:</td><td><input type="number" name="qty" class="txtField" value="<?php echo $row['ubatQty']; ?>"></td>
			   </tr>
