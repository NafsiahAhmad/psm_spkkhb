  ...
  <body class="skin-blue">
	...
	<p id="success"></p>
        <div class="table-wrapper">
          ...
          <td><a href="admin_kemaskinikucing.php?catID=<?php echo $row["catID"]; ?>"><i class="fa fa-pencil-square" style="font-size:24px;color:green "></i></a>
          <a href="actiondeletecat.php?catID=<?php echo $row["catID"]; ?>"><i class="fa fa-trash" style="font-size:24px;color:red"></i></a></td>
				</tr>
				<?php
				$i++;
				}
