        ...
        <section class="content">
          ...
          <div class='box box-default'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class="fa fa-tag"></i> Tambah Maklumat Kucing</h3>
            </div>
            <div class='box-body'>
   
            <form  method="post" name="register" action="functions/actionaddcat.php"> 
    ...
    while($row = mysqli_fetch_array($records)){
        ...
        <?php } ?>
          ...
          <tr>
			   ...
			   <tr>
					<td><b>Baka</b></td><td>:</td><td><input type="text"  name="baka"  required></td>
			   </tr>
			   <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
          <td><b>Berat</b></td><td>:</td><td><input type="text" name="berat"  required></td>
			   </tr>
         <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
          <td><b>Umur/Tarikh Lahir</b></td><td>:</td><td><input type="text" name="umur"  required></td>
			   </tr>
         <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
          <td><b>Jantina</b></td><td>:</td><td><input type="text" name="jantina"  required></td>
			   </tr>
         <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
          <td><b>Warna/Corak</b></td><td>:</td><td><input type="text" name="warna"  required></td>
			   </tr>
			   <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
