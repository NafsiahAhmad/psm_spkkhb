      ...
      <div class="content-wrapper">
        ...
        <section class="content">
          ...
          <div class='box box-default'>
            ...
            echo "<script>window.location.href='pekerja_senaraikucing.php';</script>"; } ?>
            </div>
			   ...
			   <tr>
         <tr>
					<td><b>Nama Pelanggan</b></td><td>:</td><td><?php echo $row['custName']; ?>
          </td>
			   </tr>
         <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
         <td><b>Nama Kucing</b></td><td>:</td><td><input type="text" name="catName" class="txtField" value="<?php echo $row['catName']; ?>">
