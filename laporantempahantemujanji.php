        ...
        <section class="content">
          ...
          <div class='box box-default'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class="fa fa-tag"></i> Laporan Tempahan Temujanji</h3>
            </div>
            <div class='box-body'>
            ...
            <table class="table table-striped table-hover">
                ...
                <?php 
                                ...
                                if(isset($_GET['from_date']) && isset($_GET['to_date']))
                                {
                                    ...
                                    $query = "SELECT * FROM slottempahan WHERE tarikhTempah BETWEEN '$from_date' AND '$to_date' order by tarikhTempah";
                                    ...
                                    { 
                                        foreach($query_run as $row)
                                        {
                                            ...
                                            <tr>
                                                ...
                                                <td><?= $row['custName']; ?></td>
                                                <td><?= $row['namaKucingTempah']; ?></td>
                                                <td><?= $row['rawatanType']; ?></td>
                                                <td><?= $row['statusTempah']; ?></td>
