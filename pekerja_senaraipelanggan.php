  ...
  <body class="skin-blue">
	...
	<p id="success"></p>
        <div class="table-wrapper">
          ...
          <td><a href="pekerja_kemaskinipelanggan.php?custID=<?php echo $row["custID"]; ?>"><i class="fa fa-pencil-square" style="font-size:24px;color:green "></i></a>
          <a href="functions/actiondeletecustomer.php?custID=<?php echo $row["custID"]; ?>"><i class="fa fa-trash" style="font-size:24px;color:red"></i></a></td>
				</tr>
				<?php
				$i++;
				}
