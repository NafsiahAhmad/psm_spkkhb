	...
	<p id="success"></p>
        <div class="table-wrapper">
            ...
            <th>TINDAKAN</th>
				...
				<?php
				$result = mysqli_query($conn,"SELECT * FROM kucing ORDER BY custName ASC");
					$i=1;
          ...
          <td><a href="pekerja_kemaskinikucing.php?catID=<?php echo $row["catID"]; ?>"><i class="fa fa-pencil-square" style="font-size:24px;color:green "></i></a>
          <a href="functions/actiondeletecat.php?catID=<?php echo $row["catID"]; ?>"><i class="fa fa-trash" style="font-size:24px;color:red"></i></a></td>
				</tr>
				<?php
				$i++;
				}
