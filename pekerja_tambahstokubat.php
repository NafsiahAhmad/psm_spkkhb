        ...
        <section class="content">
          ...
          <div class='box box-default'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class="fa fa-tag"></i> Tambah Stok Ubat</h3>
            </div>
            <div class='box-body'>
   
               <form action="functions/actionaddstock.php"  method="post">
			   <table border="0" width="80%" align="center" cellspacing="10">
               <tr>
					<td><b>Nama Ubat</b></td><td>:</td><td><input type="text" name="ubatName"  ></td>
			   </tr>
               <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
          <tr>
					<td><b>Kuantiti Sedia Ada</b></td><td>:</td><td><input type="number" name="ubatQty" ></td>
			   </tr>
			   <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
