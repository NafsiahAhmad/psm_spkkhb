        ...
        <section class="content">
          ...
          <div class='box box-default'>
            <div class='box-header with-border'>
              <h3 class='box-title'><i class="fa fa-tag"></i> Tambah Pentadbir</h3>
            </div>
            <div class='box-body'>
   
          <form  method="post" name="register" action="actionaddadmin.php"> 
         ...
         <td colspan="3">&nbsp;</td> 
			    ...
			    <tr>
					<td><b>Nama</b></td><td>:</td><td><input type="text" name="name" required></td>
			   </tr>
         <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
					<td><b>Nombor Telefon</b></td><td>:</td><td><input type="tel" name="phone" required></td>
			   </tr>
			   <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
			    <tr>
					<td><b>Email</b></td><td>:</td><td><input type="text" name="email" required></td>
			   </tr>
			   <tr>
					<td colspan="3">&nbsp;</td>
			   </tr>
